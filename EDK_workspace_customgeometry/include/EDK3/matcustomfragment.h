...
namespace EDK3 {
  ...
  class MatCustomFragment : public Material {
  public:
	MatCustomFragment();
  ...
  protected:
    virtual ~MatCustomFragment() {}
  private:
    ref_ptr<dev::Program> program_;
	MatCustomFragment(const MatCustomFragment&);
	MatCustomFragment& operator=(const MatCustomFragment &);
