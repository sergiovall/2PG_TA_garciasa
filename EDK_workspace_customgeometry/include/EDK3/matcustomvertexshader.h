...
namespace EDK3 {
  ...
  class MatCustomVertexShader : public Material {
  public:
	MatCustomVertexShader();
  ...
  protected:
    virtual ~MatCustomVertexShader() {}
  private:
    ref_ptr<dev::Program> program_;
	MatCustomVertexShader(const MatCustomVertexShader&);
	MatCustomVertexShader& operator=(const MatCustomVertexShader &);
